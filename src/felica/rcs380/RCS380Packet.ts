import './utils'
import { asLittleEndian, checkSumUint8Array } from './utils'
...
export class SendPacket extends RCS380Packet {
  constructor(data: Uint8Array) {
    ...
    const dataLength = asLittleEndian(data.byteLength)
    const dataLengthCheckSum = checkSumUint8Array(dataLength)
    const dataCheckSum = checkSumUint8Array(data)
...
export class FelicaSuccessPacket extends SuccessPacket {
    constructor(payload: Uint8Array) {
        super(payload)
      }
